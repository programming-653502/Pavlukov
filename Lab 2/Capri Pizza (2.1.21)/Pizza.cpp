...
int num_of_people (int start_hour, int finish_hour)
{
	...
	printf ("\nПредполагаемое количество поситителей в часы работы от %02i до %02i составляет %i человек.\n", start_hour, finish_hour, num_ppl);
...
int main()
{
	...
	for (;;)
	{
		printf ("\n\t\t\tMENU\n");
		printf ("\n--------------------------------------------------------------------\n");
		printf ("\n1 - Ввод промежутка времени работы пиццерии.\n2 - Вывод предполагаемого количества поситителей.\n3 - Расчет количества ингридиентов и вывод общей стоимости заказа.");
